...
const Pics = ({filterData}) => {
  ...
  var isConfirmed = false, isConfirmationShown = false
 ...
 if(uploadedImages)
 {
  ...
  return (
    ...
    {isFull ? ( <FullScreen handle={handle}>
      ...
      <FaTimes className=' text-red-800 text-bold ' /> 
      ...
      {displayImages.map((upload) => (
           <Pic picture = { upload }   toggleFullScreen= {toggleFullScreen} DeleteImage={DeleteImage}/>
